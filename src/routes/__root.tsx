...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aaron Hampton — Director & Cinematographer" },
      { name: "description", content: "HB.3KK / Aaron Hampton — director and cinematographer based in the DMV. Cinematic sports films and brand stories." },
